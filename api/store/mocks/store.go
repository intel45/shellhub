...
// AddNamespaceUser provides a mock function with given fields: ctx, namespace, ID, username
func (_m *Store) AddNamespaceUser(ctx context.Context, namespace string, ID string, username string) (*models.Namespace, error) {
	ret := _m.Called(ctx, namespace, ID, username)

	var r0 *models.Namespace
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) *models.Namespace); ok {
		r0 = rf(ctx, namespace, ID, username)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string, string) error); ok {
		r1 = rf(ctx, namespace, ID, username)
	} else {
		r1 = ret.Error(1)
	}
...
// RemoveNamespaceUser provides a mock function with given fields: ctx, namespace, ID, username
func (_m *Store) RemoveNamespaceUser(ctx context.Context, namespace string, ID string, username string) (*models.Namespace, error) {
	ret := _m.Called(ctx, namespace, ID, username)
